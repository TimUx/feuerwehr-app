...
function searchHazardousMaterial($unNumber) {
    ...
    $materials = [
        ...
        '1001' => [
            'un' => '1001',
            'name' => 'Acetylen, gelöst',
            'class' => '2.1',
            'classLabel' => 'Entzündbare Gase',
            'dangers' => ['Hochentzündlich', 'Unter Druck', 'Kann explosive Atmosphäre bilden'],
            'hazardLabels' => ['2.1'],
            'packingGroup' => '-',
            'description' => 'Hochentzündliches, gelöstes Gas. Kann explosive Gemische bilden.',
            'firstAid' => 'Bei Einatmen: Frischluft. Bei Erfrierung: Mit lauwarmem Wasser spülen.',
            'firefighting' => 'Behälter aus Gefahrenbereich entfernen. Mit Wasser kühlen.',
            'spillage' => 'Bereich absperren. Zündquellen beseitigen. Lüften.'
        ],
        '1016' => [
            'un' => '1016',
            'name' => 'Kohlenmonoxid',
            'class' => '2.3',
            'classLabel' => 'Giftige Gase',
            'dangers' => ['Sehr giftig', 'Entzündbar', 'Unter Druck'],
            'hazardLabels' => ['2.3', '2.1'],
            'packingGroup' => '-',
            'description' => 'Sehr giftiges, farb- und geruchloses Gas. Hochentzündlich.',
            'firstAid' => 'Bei Einatmen: SOFORT Frischluft. Sauerstoff geben. SOFORT Arzt!',
            'firefighting' => 'Umgebungsbrände bekämpfen. CSA erforderlich! Behälter kühlen.',
            'spillage' => 'SOFORT evakuieren. Nur mit CSA. Zündquellen beseitigen.'
        ],
        '1040' => [
            'un' => '1040',
            'name' => 'Ethylenoxid',
            'class' => '2.1',
            'classLabel' => 'Entzündbare Gase',
            'dangers' => ['Hochentzündlich', 'Krebserzeugend', 'Erbgutverändernd'],
            'hazardLabels' => ['2.1'],
            'packingGroup' => '-',
            'description' => 'Hochentzündliches, giftiges Gas. Kann Krebs erzeugen.',
            'firstAid' => 'Bei Einatmen: SOFORT Frischluft. Bei Hautkontakt: Mit Wasser abspülen.',
            'firefighting' => 'CSA tragen! Behälter kühlen. Gasflamme nur löschen wenn Leck geschlossen.',
            'spillage' => 'Großräumig evakuieren. Zündquellen beseitigen. Nur CSA-Träger!'
        ],
        '1045' => [
            'un' => '1045',
            'name' => 'Fluor, verdichtet',
            'class' => '2.3',
            'classLabel' => 'Giftige Gase',
            'dangers' => ['Sehr giftig', 'Ätzend', 'Oxidierend'],
            'hazardLabels' => ['2.3', '5.1', '8'],
            'packingGroup' => '-',
            'description' => 'Sehr giftiges, ätzendes und oxidierendes Gas. Gelbgrün.',
            'firstAid' => 'Bei Kontakt: SOFORT Arzt! Mit Wasser spülen. CSA erforderlich!',
            'firefighting' => 'Nur speziell ausgebildete Kräfte. CSA Pflicht. Behälter kühlen.',
            'spillage' => 'Großräumig evakuieren. SOFORT Feuerwehr. Nur mit CSA!'
        ],
        '1120' => [
            'un' => '1120',
            'name' => 'Butanole',
            ...
            'hazardLabels' => ['3'],
            'packingGroup' => 'III',
            'description' => 'Entzündbare Flüssigkeit. Dämpfe können Schläfrigkeit verursachen.',
            'firstAid' => 'Bei Einatmen: Frischluft. Bei Hautkontakt: Mit Wasser waschen.',
            'firefighting' => 'Alkoholbeständiger Schaum, Pulver, CO2.',
            'spillage' => 'Zündquellen beseitigen. Mit Bindemittel aufnehmen.'
        ],
        '1193' => [
            'un' => '1193',
            'name' => 'Ethylmethylketon (MEK)',
            'class' => '3',
            'classLabel' => 'Entzündbare flüssige Stoffe',
            'dangers' => ['Hochentzündlich', 'Reizend'],
            'hazardLabels' => ['3'],
            'packingGroup' => 'II',
            'description' => 'Hochentzündliche Flüssigkeit. Reizt Augen und Atemwege.',
            'firstAid' => 'Bei Augenkontakt: 15 Min. mit Wasser spülen. Bei Einatmen: Frischluft.',
            'firefighting' => 'Schaum, Pulver, CO2. Behälter kühlen.',
            'spillage' => 'Zündquellen beseitigen. Mit Bindemittel aufnehmen. Lüften.'
        ],
        '1219' => [
            ...
            'class' => '3',
            'classLabel' => 'Entzündbare flüssige Stoffe',
            'dangers' => ['Entzündbar', 'Reizend'],
            'hazardLabels' => ['3'],
            'packingGroup' => 'II',
            'description' => 'Entzündbare Flüssigkeit. Reizt die Augen stark.',
            'firstAid' => 'Bei Augenkontakt: Mit Wasser spülen. Bei Verschlucken: Mund ausspülen.',
            'firefighting' => 'Alkoholbeständiger Schaum, Pulver, CO2.',
            'spillage' => 'Zündquellen beseitigen. Mit Bindemittel aufnehmen.'
        ],
        '1263' => [
            'un' => '1263',
            'name' => 'Farbe (entzündbar)',
            'class' => '3',
            'classLabel' => 'Entzündbare flüssige Stoffe',
            'dangers' => ['Entzündbar', 'Gesundheitsschädlich'],
            'hazardLabels' => ['3'],
        ...
        '1600' => [
            'un' => '1600',
            'name' => 'Dinitrotoluol, geschmolzen',
            'class' => '6.1',
            'classLabel' => 'Giftige Stoffe',
            'dangers' => ['Giftig', 'Umweltgefährdend'],
            'hazardLabels' => ['6.1'],
            'packingGroup' => 'II',
            'description' => 'Giftig bei Hautkontakt und Einatmen. Umweltgefährdend.',
            'firstAid' => 'Bei Hautkontakt: Sofort mit Wasser und Seife waschen. Kontaminierte Kleidung entfernen.',
            'firefighting' => 'Schaum, Pulver, CO2. Vorsicht: Giftige Dämpfe!',
            'spillage' => 'CSA tragen. Mit Sand aufnehmen. Nicht in Gewässer.'
        ],
        '1805' => [
            'un' => '1805',
            'name' => 'Phosphorsäure',
        ...
        '1823' => [
            'un' => '1823',
            'name' => 'Natriumhydroxid, fest',
            'class' => '8',
            'classLabel' => 'Ätzende Stoffe',
            'dangers' => ['Ätzend'],
            'hazardLabels' => ['8'],
            'packingGroup' => 'II',
            'description' => 'Verursacht schwere Verätzungen und schwere Augenschäden.',
            'firstAid' => 'Bei Hautkontakt: Sofort mit viel Wasser abspülen. Kontaminierte Kleidung entfernen.',
            'firefighting' => 'Nach Umgebung. Vorsicht bei Reaktion mit Wasser (Wärmeentwicklung).',
            'spillage' => 'Trocken aufsammeln. Vorsichtig mit Wasser aufnehmen. Mit Säure neutralisieren.'
        ],
        '1956' => [
            'un' => '1956',
            'name' => 'Druckgas, n.a.g. (komprimiert)',
            'class' => '2.2',
            'classLabel' => 'Nicht entzündbare, nicht giftige Gase',
            'dangers' => ['Unter Druck', 'Kann Erstickung verursachen'],
            'hazardLabels' => ['2.2'],
            'packingGroup' => '-',
            'description' => 'Nicht brennbares Gas unter Druck. Kann Erstickung verursachen.',
            'firstAid' => 'Bei Atemnot: Frischluft. Sauerstoff geben. Person warm halten.',
            'firefighting' => 'Behälter aus Gefahrenbereich entfernen oder mit Wasser kühlen.',
            'spillage' => 'Bereich lüften. Nicht in geschlossene Räume.'
        ],
        '1971' => [
            'un' => '1971',
            'name' => 'Methan, verdichtet (Erdgas)',
            'class' => '2.1',
            'classLabel' => 'Entzündbare Gase',
            'dangers' => ['Hochentzündlich', 'Unter Druck', 'Erstickend'],
            'hazardLabels' => ['2.1'],
            'packingGroup' => '-',
            'description' => 'Hochentzündliches, farbloses, geruchloses Gas. Leichter als Luft.',
            'firstAid' => 'Bei Einatmen: Frischluft. Bei Atemnot: Sauerstoff geben.',
            'firefighting' => 'Behälter kühlen. Gasflamme nicht löschen, außer Leck kann geschlossen werden.',
            'spillage' => 'Zündquellen beseitigen. Bereich lüften. Gas steigt nach oben.'
        ],
        '2014' => [
            'un' => '2014',
            'name' => 'Wasserstoffperoxid, wässrige Lösung',
            'class' => '5.1',
            'classLabel' => 'Oxidierende Stoffe',
            'dangers' => ['Oxidierend', 'Ätzend', 'Verstärkt Verbrennung'],
            'hazardLabels' => ['5.1', '8'],
            'packingGroup' => 'II',
            'description' => 'Starkes Oxidationsmittel. Ätzend. Kann Brand verstärken.',
            'firstAid' => 'Bei Hautkontakt: Sofort mit viel Wasser spülen. Bei Augenkontakt: 15 Min. spülen.',
            'firefighting' => 'Nach Umgebung. Vorsicht: Verstärkt Verbrennung! Mit Wasser kühlen.',
            'spillage' => 'Mit viel Wasser verdünnen. Von brennbaren Stoffen fernhalten.'
        ],
        '2448' => [
            'un' => '2448',
            'name' => 'Schwefel, geschmolzen',
            'class' => '4.1',
            'classLabel' => 'Entzündbare feste Stoffe',
            'dangers' => ['Entzündbar', 'Giftige Dämpfe beim Erhitzen'],
            'hazardLabels' => ['4.1'],
            'packingGroup' => 'III',
            'description' => 'Entzündbarer Feststoff. Entwickelt beim Erhitzen giftige Dämpfe (SO2).',
            'firstAid' => 'Bei Verbrennungen: Mit Wasser kühlen. Bei Einatmen von Dämpfen: Frischluft.',
            'firefighting' => 'Mit Wasser, Schaum oder Pulver löschen. Vorsicht: Giftige Dämpfe!',
            'spillage' => 'Erkalten lassen. Mechanisch aufnehmen. Von Zündquellen fernhalten.'
        ],
        '2790' => [
            'un' => '2790',
            'name' => 'Essigsäure, Lösung',
            'class' => '8',
            'classLabel' => 'Ätzende Stoffe',
            'dangers' => ['Ätzend', 'Entzündbar (>90%)'],
            'hazardLabels' => ['8', '3'],
            'packingGroup' => 'II/III',
            'description' => 'Ätzende Flüssigkeit. Konzentrierte Lösungen sind entzündbar.',
            'firstAid' => 'Bei Hautkontakt: Mit Wasser abspülen. Bei Augenkontakt: 15 Min. spülen.',
            'firefighting' => 'Schaum, Pulver, CO2. Behälter kühlen. Vorsicht: Ätzende Dämpfe!',
            'spillage' => 'Mit Bindemittel aufnehmen. Neutralisieren mit Soda oder Kalk.'
        ],
        '3164' => [
            'un' => '3164',
            'name' => 'Druckvorrichtungen, pneumatisch oder hydraulisch',
            'class' => '2.2',
            'classLabel' => 'Nicht entzündbare, nicht giftige Gase',
            'dangers' => ['Unter Druck', 'Kann bei Beschädigung bersten'],
            'hazardLabels' => ['2.2'],
            'packingGroup' => '-',
            'description' => 'Druckbehälter mit Gas oder Hydraulikflüssigkeit unter Druck.',
            'firstAid' => 'Bei Verletzungen: Erstversorgung. Bei Gasaustritt: Frischluft.',
            'firefighting' => 'Nach Umgebung. Behälter aus Gefahrenbereich entfernen oder kühlen.',
            'spillage' => 'Bereich absperren. Druckentlastung durch Fachpersonal.'
        ],
        '3257' => [
            'un' => '3257',
            'name' => 'Flüssigkeit, erhitzt, n.a.g.',
            'class' => '9',
            'classLabel' => 'Verschiedene gefährliche Stoffe',
            'dangers' => ['Sehr heiß', 'Verbrennungsgefahr'],
            'hazardLabels' => ['9'],
            'packingGroup' => 'III',
            'description' => 'Flüssigkeit bei erhöhter Temperatur. Verbrennungsgefahr bei Kontakt.',
            'firstAid' => 'Bei Verbrennungen: Mit Wasser kühlen. Steril abdecken. Arzt konsultieren.',
            'firefighting' => 'Nach Umgebung. VORSICHT vor heißer Flüssigkeit!',
            'spillage' => 'Abkühlen lassen. Bereich absperren. Mit geeignetem Material aufnehmen.'
        ],
        '3480' => [
            'un' => '3480',
            'name' => 'Lithium-Ionen-Batterien',
            'class' => '9',
            'classLabel' => 'Verschiedene gefährliche Stoffe',
            'dangers' => ['Brand- und Explosionsgefahr bei Beschädigung', 'Giftige Dämpfe'],
            'hazardLabels' => ['9'],
            'packingGroup' => 'II',
            'description' => 'Lithium-Ionen-Akkus. Brandgefahr bei Beschädigung, Überhitzung.',
            'firstAid' => 'Bei Verätzungen: Mit Wasser spülen. Bei Rauchentwicklung: Frischluft.',
            'firefighting' => 'Mit viel Wasser kühlen! Nicht löschen mit CO2. Vorsicht: Wiederaufflammen möglich!',
            'spillage' => 'Beschädigte Batterien in Sand oder Vermiculit. NICHT in Wasser!'
        ]
    ];
